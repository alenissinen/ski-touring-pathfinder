 ...
 *
 * <p>At least for now extends {@link RuntimeException} because the application
 * can't render without a working shader. Might change this later e.g. try to recompile
 * the shader etc. if I figure out a way.</p>
 */
public class ShaderException extends RuntimeException {
    /**
     * Constructs a new {@code ShaderException} with a message and the path of the shader.
