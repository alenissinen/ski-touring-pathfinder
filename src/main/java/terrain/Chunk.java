 ...
 * to and from the GPU.
 *
 * <p>Chunks are identified by their grid position (x,z)</p>
 *
 * <p>Each chunk holds a reference to the full {@link HeightMap} with an offset
 * instead of creating a copy, to save memory and provide access to neighboring chunks</p>
 *
 * <p>Must be cleaned up with {@link #dispose()} when no longer needed to free
 * GPU resources. Implements {@link AutoCloseable} to support try-with-resources.</p>
 */
public class Chunk implements AutoCloseable {
     ...
     *
     * <p>Vertices are {@code (x, y, z)} floats where {@code y} is the
     ...
     *
     * <p>Use try-with-resources when viable.</p>
     * <pre>{@code
